...
| [Customisable CV](https://github.com/makersacademy/example-story-website) | Working with Makers Academy to develop a customisable website that Makers graduates can use to showcase their skills   <br><br>[See it live](https://makers-dev.netlify.app/)                                                                                           | React - Gatsby, GraphQL, Jest, Enzyme, SCSS             |
| [My Secret Garden](https://my-secret-garden-dun.vercel.app/)              | A website designed to help people locate gardens in and around London                                                                                                                                             | React - Next, MongoDB, Express, Google Maps API         |
