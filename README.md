...
| [Customisable CV](https://github.com/makersacademy/example-story-website) | Working with Makers Academy to develop a customisable website template that Makers graduates can use to showcase their potential   <br><br>[See it live](https://makers-dev.netlify.app/)                                                                                           | React - Gatsby, GraphQL, Jest, Enzyme, SCSS             |
